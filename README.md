...
---
## Funkce 
Skript ´File_cleaner.sh´ umožňuje:

1. uživatel stáhne soubor z webu nebo nahraje z jiného zařízení
2. file_cleaner roztřídí jednotlivé soubory podle koncovek
   
         a) obrázky (.jpg, .png, .webp, .svg)
         b) dokumenty ( pdf, docx, xlsx, txt)   
         c) videa (mp4, mkv)
         d) hudba (mp3)
         e) archiv (zip, rar)
         f) ostatní (sem budou patřit všechny zbylé neroztříděné dokumenty)
